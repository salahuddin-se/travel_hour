                  ...
                  FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        if (ib.hasInternet == false) {
                          ...
                          openToast(context, 'no internet'.trim());
                        } else {
                          if (sb.uid != d.uid) {
                            Navigator.pop(context);
                  ...
                  ? ListView(
                      children: [
                        ...
                        EmptyPage(
                            ...
                            message: 'no comments found'.trim(),
                            message1: 'be the first to comment'.trim()),
                      ],
                    )
                  : ListView.separated(
              ...
              child: Container(
                ...
                child: TextFormField(
                  decoration: InputDecoration(
                      ...
                      hintText: widget.collectionName == 'places' ? 'write a review'.trim() : 'write a comment'.trim(),
