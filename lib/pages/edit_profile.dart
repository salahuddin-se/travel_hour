...
class _EditProfileState extends State<EditProfile> {
  ...
  Future uploadPicture() async {
    ...
    StorageReference storageReference = FirebaseStorage.instance.ref().child('Profile Pictures/${sb.uid}');
  ...
  handleUpdateData () async {
    ...
    if (ib.hasInternet == false) {
      openSnacbar(scaffoldKey, 'no internet'.trim());
    } else {
      ...
      ? await sb.updateUserProfile(nameCtrl.text, imageUrl)
        .then((value){
          openSnacbar(scaffoldKey, 'updated successfully'.trim());
